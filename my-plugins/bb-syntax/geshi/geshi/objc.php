...
$language_data = array (
    ...
    'KEYWORDS' => array(
        ...
        5 => array(
            ...
            'SPALSound', 'SPALSoundChannel', 'SPAVSound', 'SPAVSoundChannel',
            'SPAudioEngine', 'SPBitmapChar', 'SPBitmapFont', 'SPButton',
            'SPCompiledSprite', 'SPDelayedInvocation', 'SPDisplayObject', 'SPDisplayObjectContainer',
            'SPEnterFrameEvent', 'SPEvent', 'SPEventDispatcher', 'SPGLTexture',
            'SPImage', 'SPJuggler', 'SPMatrix', 'SPMovieClip',
            'SPPoint', 'SPPoolObject', 'SPQuad', 'SPRectangle',
            'SPRenderSupport', 'SPRenderTexture', 'SPSound', 'SPSoundChannel',
            'SPSprite', 'SPStage', 'SPSubTexture', 'SPTextField',
            'SPTexture', 'SPTextureAtlas', 'SPTouch', 'SPTouchEvent',
            'SPTouchProcessor', 'SPTransitions', 'SPTween', 'SPTweenedProperty',
            'SPUtils', 'SPView'
            ),
